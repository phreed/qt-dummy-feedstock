...
[source,powershell]
----
conda install -c local qt-dummy
----
...
`C:\tools\miniconda3\conda-bld\win-64\qt-dummy-5.2.1-hedb21ad_0.tar.bz2`.
You can expect the content of the archive to be..

Name: qt-dummy-5.2.1-h9df6293_0.tar

* etc
* conda
** activate.d : scripts run during activation
*** qt-dummy-activate.bat
*** qt-dummy-activate.sh
** deactivate.d : scripts run during deactivation
*** qt-dummy-deactivate.bat
*** qt-dummy-deactivate.sh
* info
...
** .qt-dummy-post-link.bat
** .qt-dummy-pre-unlink.bat
...
[source,txt]
----
Scripts/.qt-dummy-post-link.bat
Scripts/.qt-dummy-pre-unlink.bat
etc/conda/activate.d/qt-dummy-activate.bat
etc/conda/activate.d/qt-dummy-activate.sh
etc/conda/deactivate.d/qt-dummy-deactivate.bat
etc/conda/deactivate.d/qt-dummy-deactivate.sh
----
...
link:https://github.com/phreed/qt-dummy-feedstock/actions[Check the Github action status.]
